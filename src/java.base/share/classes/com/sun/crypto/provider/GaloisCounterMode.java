...
final class GaloisCounterMode extends FeedbackCipher {
    ...
    // inOfs = c_rarg1 (rdx)   |  c_rarg1 (rdi)
    // len = c_rarg2 (r8)      |  c_rarg2 (rdx)
    // ct = c_rarg3 (r9)       |  c_rarg3 (rcx)
    // ctOfs = r10             |  c_rarg3 (r8)
    // out = r11               |  c_rarg3 (r9)
    // outOfs = r12            |  r10
    // processInChunks = r13   |  r11
    // state = r14            .|  r14
    // subkeyHtbl = rdi        |  r12
    // counter = rsi           |  r13
    // key obtained from AESCrypt object
